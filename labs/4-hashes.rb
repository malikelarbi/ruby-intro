...
"Tomorrow it will be #{weather_data [:forecast]
...
puts "The next day it we will see #{weather_data[:forecast][1][:conditions]} skies, with a temperature of #{weather_data[:forecast][0][:conditions].""